        ...
        $.iframeHeight.resizeIframe = function(){
            ...
            if(isThisCDI()){
                ...
                if(base.$el.get(0).contentWindow.document.body !== null) {
                    ...
                    var _pageName = base.$el.get(0).contentWindow.document.location.pathname.substring(base.$el.get(0).contentWindow.document.location.pathname.lastIndexOf('../index.html') + 1).toLowerCase();
