...
<body>
	...
	<div id="wrapper">
		...
		<div class="header">
			...
			<span class="header_con">* 가입시 등록한 이메일로 인증 확인 메일을 발송드립니다. *</span>			
		</div>
		<div class="container">
			<form id="formLogin" method="#" action="#" style="width: 100%">
				<fieldset style="border: none; margin-top: 40px">				
						...
						<div class="member_warning" id="member_warning" align="center">
							<input type="checkbox" id="emailCheck">
								<span class="emailCheck">이메일 인증&nbsp;(${loginSession.email})</span>													
						</div>
...
$("#btnFindPw").click(function() {
	if($("#emailCheck").is(":checked")==false) {
		...
		alert("해당 이메일로 비밀번호 발송이 완료되었습니다. 이메일 확인 후 다시 로그인하시기 바랍니다.");		
